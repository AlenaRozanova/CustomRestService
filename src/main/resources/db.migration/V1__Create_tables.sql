...
ALTER TABLE banks_users
    ADD CONSTRAINT fk_users_banks_users FOREIGN KEY (user_id) REFERENCES users (id);
ALTER TABLE banks_users
    ADD CONSTRAINT fk_users_banks_banks FOREIGN KEY (bank_id) REFERENCES banks (id);